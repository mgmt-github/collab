...
@section('frontend-content')
                                    ...
                                    <div class="tab-content mg-top-30" id="nav-tabContent">
                                        ...
                                        <div class="tab-pane fade active show" id="in-tab3" role="tabpanel">
                                            <div class="inflanar-sdetail__tcontent">
                                                ...
                                                <h4 class="inflanar-sdetail__tcontent--title mg-top-40">
                                                    {{ __('admin.Package Features') }}</h4>
                                                        ...
                                                        <ul
                                                            ...
                                                            @if ($service->features)
                                                                @foreach (json_decode($service->features) as $feature)
                                                                    @if ($feature)
                                                                        <li><img
                                                                                src="{{ asset('frontend/img/in-check-icon2.svg') }}">{{ $feature }}
                                                                        </li>
                                                                    @endif
                                                                @endforeach
                                                            @endif
                                        ...
                                        <div class="tab-pane fade" id="in-tab4" role="tabpanel">
                                            <div class="inflanar-sdetail__tcontent">
                                                <h4 class="inflanar-sdetail__tcontent--title mg-top-40">
                                                    {{ __('admin.Service Availability') }}</h4>
                                                <div class="row mg-btm-20">
                                                    <div class="col-lg-6 col-12">
                                                        <ul class="inflanar-service__list list-none">
                                                            @foreach ($schedule_list as $schedule)
                                                                <li><span
                                                                        class="inflanar-service__list--day">{{ $schedule['day'] }}</span><span>{{ $schedule['start_time'] }}
                                                                        - {{ $schedule['end_time'] }}</span></li>
                                                            @endforeach
                                        ...
                                        <div class="tab-pane fade" id="in-tab5" role="tabpanel">
                                            ...
                                            @foreach ($reviews as $index => $review)
                                                <!-- Single Review -->
                                                <div
                                                    class="inflanar-testimonial inflanar-testimonial--review inflanar-border mg-top-30">
                                                    <!-- Testimonial Text -->
                                                    <div class="inflanar-testimonial__bottom">
                                                        <!-- Testimonial Author -->
                                                        <div class="inflanar-testimonial__author">
                                                            <img src="{{ asset($review->user->image) ? asset($review->user->image) : asset($setting->default_avatar) }}"
                                                                alt="#">
                                                            <div class="inflanar-testimonial__author--info">
                                                                <h5 class="inflanar-testimonial__author--title">
                                                                    {{ $review->user->name }}</h5>
                                                                <p class="inflanar-testimonial__author--position">
                                            ...
                                            <div class="inflanar-comments-form inflanar-comments-form--reviews mg-top-50">
                                                <h2 class="inflanar-comments-form__title m-0">
                                                    {{ __('admin.Write Your Reviews') }}</h2>
                                                <form id="serviceReviewForm">
                                                    @csrf
                                                    <div class="inflanar-form-input--review">
                                                        <ul class="inflanar-rating list-none">
                                                            <li><i class="fa-solid fa-star service_rat" data-rating="1"
                                                                    onclick="productReview(1)"></i></li>
                                                            <li><i class="fa-solid fa-star service_rat" data-rating="2"
                                                                    onclick="productReview(2)"></i></li>
                                                            <li><i class="fa-solid fa-star service_rat" data-rating="3"
                                                                    onclick="productReview(3)"></i></li>
                                                            <li><i class="fa-solid fa-star service_rat" data-rating="4"
                                                                    onclick="productReview(4)"></i></li>
                                                            <li><i class="fa-solid fa-star service_rat" data-rating="5"
                                                                    onclick="productReview(5)"></i></li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 mg-top-20">
                                                            <button type="submit"
                                                                class="inflanar-btn"><span>{{ __('admin.Submit Review') }}</span></button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="inflanar-psingle__body">
                                        <ul class="inflanar-psingle__list">
                                            @if ($service->features)
                                                @foreach (json_decode($service->features) as $feature)
                                                    @if ($feature)
                                                        <li><span class="inflanar-psingle__icon"><img
                                                                    src="{{ asset('frontend/img/in-check-icon2.svg') }}"></span>{{ $feature }}
                                                        </li>
                                                    @endif
                                                @endforeach
                                            @endif
                                        ...
                                        <div class="inflanar-psingle__button">
                                            <a href="{{ route('booking-service', $service->slug) }}"
                                                class="inflanar-btn"><span>{{ __('admin.Book Now') }}</span></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Pricing Single -->
                            ...
                            <div class="service-single__sidebar mg-top-30">
                                ...
                                <div class="inflanar-influencer">
                                    ...
                                    <div class="inflanar-influencer__head">
                                        <img src="{{ $service_author->image ? asset($service_author->image) : asset($setting->default_avatar) }}"
                                            alt="#">
                                        <h4 class="inflanar-influencer__title">
                                            <a
                                                href="{{ route('influencer', html_decode($service_author->username)) }}">{{ html_decode($service_author->name) }}<span>{{ html_decode($service_author->designation) }}</span></a>
                                        </h4>
                                    </div>
                                    <!-- Influencer Body -->
                                    <div class="inflanar-influencer__body">
                                        ...
                                        @auth('web')
                                            <a class="inflanar-btn-full  mg-top-20" href="javascript:;"
                                                onclick="sendNewMessage('{{ $service_author->name }}','{{ $service_author->id }}', '{{ $service_author->designation }}', '{{ $service_author->image }}', '{{ $service->id }}', '{{ $service->name }}', '{{ $service->image }}')">{{ __('admin.Contact Here') }}</a>
                                        @else
                                            <a class="inflanar-btn-full  mg-top-20" href="javascript:;"
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="inflanar-section__head  slider-title">
                                        <div class="inflanar-section__slide">
                                            <h2 class="inflanar-section__title inflanar-section__title--medium "
                                                data-aos="fade-in" data-aos-delay="400">
                                                {{ __('admin.Related Services') }}</h2>
                                        ...
                                        <div class="swiper-wrapper ">
                                            ...
                                            @foreach ($related_services as $related_service)
                                                <div class="swiper-slide mg-btm-30">
                                                    <!-- Single property-->
                                                    <div class="cards">
                                                        <a href="{{ route('booking-service', $related_service->slug) }}"
                                                            class="card-link">
                                                            ...
                                                            <div class="box" style="background:url(''); no-repeat">
                                                                ...
                                                                <div class="heart">
                                                                    @auth('web')
                                                                        <div class="inflanar-service__wishlist {{ $service->is_wishlist($related_service->id) == true ? 'active' : '' }} add_to_wishlist"
                                                                ...
                                                                <img src="{{ asset($related_service->thumbnail_image) }}"
                                                                    class="img-box" />
                                                                <div class="img-title">
                                                                    <div>
                                                                        @if ($related_service->category)
                                                                            <a href="{{ route('services', ['categories[]' => $related_service->category->slug]) }}"
                                                                                class="inflanar-service__cat">
                                                            ...
                                                            <h4> <a
                                                                    href="{{ route('service', $related_service->slug) }}">{{ $related_service->title }}</a>
    ...
    <style>
        ...
        .cards .inflanar-service__price,
        .cards a.inflanar-service__cat {

                ...
                <ul class="nav-menu menu navigation list-none">
                    ...
                    <li class="menu-item-has-children"><a href="#">{{ __('admin.Pages') }}</a>
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{ route('terms-conditions') }}">{{ __('admin.Terms & Conditions') }}</a>
                            </li>
                        ...
                        @if (Session::get('currency_code'))
                            @foreach ($currency_list as $currency_item)
                                <option
                                    ...
                                    value="{{ $currency_item->currency_code }}">{{ $currency_item->currency_name }}
                                </option>
                            @endforeach
                        @else
                            @foreach ($currency_list as $currency_item)
                    ...
                    <div class="inflanar-header__inside">
                                ...
                                <div class="navbar">
                                    <div class="nav-item">
                                        ...
                                        <ul class="nav-menu menu navigation list-none">
                                            ...
                                            <li><a
                                                    href="{{ route('influencers') }}">{{ __('admin.Influencers') }}</a>
                                            </li>
                                            ...
                                            <li class="menu-item-has-children"><a
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    @if ($setting->commission_type == 'subscription')
                                                        @php
                                                            $json_module_data = file_get_contents(
                                                    ...
                                                    <li><a
                                                            href="{{ route('about-us') }}">{{ __('admin.About Us') }}</a>
                                                    </li>

                                                    <li><a
                                                            href="{{ route('blogs') }}">{{ __('admin.Our Blogs') }}</a>
                                                    </li>
                                                    <li><a href="{{ route('faq') }}">{{ __('admin.FAQ') }}</a></li>
                                                    <li><a
                                                    ...
                                                    <li><a
                                                            href="{{ route('privacy-policy') }}">{{ __('admin.Privacy Policy') }}</a>
                                                    </li>
                                                    @foreach ($custom_pages as $custom_page)
                                                        <li><a
                                                                href="{{ route('custom-page', $custom_page->slug) }}">{{ $custom_page->page_name }}</a>
                                            ...
                                            <li><a href="{{ route('contact-us') }}">{{ __('admin.Contact') }}</a>
                                            </li>
                                        </ul>
                                        <!-- End Main Menu -->
                                    </div>
                        ...
                        <div class="inflanar-header__button h-with-lang-switch">
                            ...
                            <div class="qnav-btn-item">
                                ...
                                @guest('web')
                                    <a href="{{ route('login') }}" class="inflanar-btn inflanar-btn--header"><span>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            ...
                            <div class="single-widget footer-useful-links">
                                ...
                                <ul class="footer__list list-none">
                                    ...
                                    <li><a href="{{ route('influencers') }}">{{ __('admin.Our Influencers') }}</a>
                                    </li>
                                    <li><a href="{{ route('blogs') }}">{{ __('admin.Our Blogs') }}</a></li>
                                    <li><a href="{{ route('contact-us') }}">{{ __('admin.Contact Us') }}</a></li>
                                    <li><a
                                            href="{{ route('terms-conditions') }}">{{ __('admin.Terms And Conditions') }}</a>
                                    </li>
                                    <li><a
                                            href="{{ route('privacy-policy') }}">{{ __('admin.Privacy Policy') }}</a>
                                    </li>
                                    <li><a href="{{ route('faq') }}">{{ __('admin.FAQ') }}</a></li>
                                    <li><a href="{{ route('user.dashboard') }}">{{ __('admin.My Profile') }}</a>
                                    </li>
                                    <li><a
                                            href="{{ route('user.change-password') }}">{{ __('admin.Change Password') }}</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- End Footer Widget -->
                    ...
                    @foreach ($providers as $provider)
                        <li class="provider-list single-provider-{{ $provider->provider_id }}"
                            ...
                            <div class="img">
                                ...
                                @else
                                    <img src="{{ asset($default_avatar->image) }}" alt="user"
                                        class="img-fluid w-100">
                                @endif

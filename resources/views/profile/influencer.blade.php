...
<div class="main-content">
    <section class="section">
      ...
      <div class="dropdown-container">
              ...
              <div class="dropdown">
                <button id="leftDropdownButton" class="dropdown-button" onclick="toggleDropdown('leftDropdown')">Platform</button>
                <div class="dropdown-content" id="leftDropdown">
                  <a href="#" onclick="selectSingleOption('leftDropdown', 'leftDropdownButton', this)">Option 1</a>
                  <a href="#" onclick="selectSingleOption('leftDropdown', 'leftDropdownButton', this)">Option 2</a>
                  <a href="#" onclick="selectSingleOption('leftDropdown', 'leftDropdownButton', this)">Option 3</a>
                </div>
              </div>
              <!-- Right Dropdown (Multiple Select) -->
              <div class="dropdown">
                <button id="rightDropdownButton" class="dropdown-button" onclick="toggleDropdown('rightDropdown')">
                  <div class="selected-items"></div>
                  <span class="dropdown-button-text">Beauty</span>
                </button>
                <div class="dropdown-content" id="rightDropdown">
                  <a href="#" id="option1" data-value="Option A" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option A</a>
                  <a href="#" id="option2" data-value="Option B" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option B</a>
                  <a href="#" id="option3" data-value="Option C" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option C</a>
                  <a href="#" id="option4" data-value="Option D" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option D</a>
                  <a href="#" id="option5" data-value="Option E" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option E</a>
                  <a href="#" id="option6" data-value="Option F" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option F</a>
                  <a href="#" id="option7" data-value="Option G" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option G</a>
                  <a href="#" id="option8" data-value="Option H" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option H</a>
                  <a href="#" id="option9" data-value="Option I" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option I</a>
                  <a href="#" id="option10" data-value="Option J" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option J</a>
                  <a href="#" id="option11" data-value="Option K" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option K</a>
                  <a href="#" id="option12" data-value="Option L" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option L</a>
                  <a href="#" id="option13" data-value="Option M" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option M</a>
                  <a href="#" id="option14" data-value="Option N" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option N</a>
                  <a href="#" id="option15" data-value="Option O" onclick="toggleMultipleSelection('rightDropdown', 'rightDropdownButton', this)">Option O</a>
                </div>
              </div>
              <!-- Search Button -->
              <button type="button" class="search-button">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="
    </svg>
</div>
                  <img src="{{ asset('uploads/layout-images/img1.png') }}" class="img-box" />
                  <div class="img-title">
                    <div>
                      <h5>Sheila Boyer</h5>
                      <address>Traverse City, MI, US</address>
                    </div>
                    <span>Top creator</span>
                  </div>
                </div>
                <h4> Instagram <strong>$1200</strong>
                </h4>
                <p>Fashion, Beauty, And Lifestyle Blogger</p>
              </div>
               <div class="cards">
                <div class="box" style="background:url(''); no-repeat">
                <div class="heart" onclick="toggleHeart(this)">
    ...
    <svg class="dark-heart" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M12.2994 20.4845C17.3662 17.0586 22.433 13.2462 22.433 8.17944C22.433 6.88234 21.9386 5.58596 20.9491 4.59649C19.9596 3.60774 18.6633 3.11264 17.3662 3.11264C16.0698 3.11264 14.7727 3.60774 13.7839 4.59649L12.2994 6.08106L10.8155 4.59649C9.82604 3.60774 8.52967 3.11264 7.23257 3.11264C5.93619 3.11264 4.63909 3.60774 3.65034 4.59649C2.66087 5.58596 2.16577 6.88234 2.16577 8.17944C2.16577 13.2462 7.23257 17.0586 12.2994 20.4845Z" fill="#FF0000" />
                  ...
                  <img src="{{ asset('uploads/layout-images/img2.png') }}" class="img-box" />
                  <div class="img-title">
                    <div>
                      <h5>Sheila Boyer</h5>
                      <address>Traverse City, MI, US</address>
    ...
    <svg class="dark-heart" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M12.2994 20.4845C17.3662 17.0586 22.433 13.2462 22.433 8.17944C22.433 6.88234 21.9386 5.58596 20.9491 4.59649C19.9596 3.60774 18.6633 3.11264 17.3662 3.11264C16.0698 3.11264 14.7727 3.60774 13.7839 4.59649L12.2994 6.08106L10.8155 4.59649C9.82604 3.60774 8.52967 3.11264 7.23257 3.11264C5.93619 3.11264 4.63909 3.60774 3.65034 4.59649C2.66087 5.58596 2.16577 6.88234 2.16577 8.17944C2.16577 13.2462 7.23257 17.0586 12.2994 20.4845Z" fill="#FF0000" />
                  ...
                  <img src="{{ asset('uploads/layout-images/img3.png') }}" class="img-box" />
                  <div class="img-title">
                    <div>
                      <h5>Sheila Boyer</h5>
                      <address>Traverse City, MI, US</address>
...
<script>
    ...
    function toggleHeart(box) {
        ...
        // Toggle visibility
        if (lightHeart.style.display === "none") {
            lightHeart.style.display = "block";
            darkHeart.style.display = "none";
        } else {
            lightHeart.style.display = "none";
            darkHeart.style.display = "block";
        }
    }
</script>
      ...
      function toggleMultipleSelection(dropdownId, buttonId, element) {
        ...
        if (isSelected) {
          ...
          removeIcon.onclick = function() {
            ...
            const option = document.querySelector(`#${dropdownId} .dropdown-content a[data-value="${selectedValue}"]`);
            if (option) {
        ...
        if (selectedItemsContainer.children.length > 0) {
          ...
          dropdownButton.querySelector('.dropdown-button-text').style.display = "block"; // Show the "Beauty" text again if no items are selected
        }
        // Close the dropdown
        document.getElementById(dropdownId).style.display = "none";
      }

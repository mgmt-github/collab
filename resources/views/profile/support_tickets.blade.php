...
@section('frontend-content')
    <style>
        ...
        tbody.inflanar-table__body,
        tbody.inflanar-table__body p {
            color: #292D32;
            font-family: Poppins;
            font-size: 14px;
            font-style: normal;
    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <!-- Support TIcket  -->
                <div class="inflanar-preview__modal modal fade" id="open_ticket" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered inflanar-preview__ticket">
                        <div class="modal-content">
                            <div class="modal-header inflanar__modal__header">
                                <h4 class="modal-title inflanar-preview__modal-title" id="OpenTicketmodal">
                                    {{ __('admin.Open New Ticket') }}</h4>
                                <button type="button" class="inflanar-preview__modal--close btn-close"
                                    data-bs-dismiss="modal" aria-label="Close"><i class="fas fa-remove"></i></button>
                            </div>
                                        ...
                                        <div class="col-12 mg-top-20">
                                            <div class="form-group inflanar-form-input">
                                                ...
                                                <input class="ecom-wc__form-input" type="text" name="subject"
                                                    placeholder="{{ __('admin.Your Subject') }}">
                                            </div>
                                        </div>
                                        <div class="col-12 mg-top-20">
                                            <div class="form-group inflanar-form-input">
                    ...
                    <div class="inflanar-supports">
                        <div class="inflanar-supports__head">
                            ...
                            <div class="inflanar-supports__buttons">
                                <a href="#" class="inflanar-btn" data-bs-toggle="modal"
                                    data-bs-target="#open_ticket">{{ __('admin.Open Ticket') }}
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path id="Vector"
                                            d="M10.0003 1.66666C5.40866 1.66666 1.66699 5.40833 1.66699 10C1.66699 14.5917 5.40866 18.3333 10.0003 18.3333C14.592 18.3333 18.3337 14.5917 18.3337 10C18.3337 5.40833 14.592 1.66666 10.0003 1.66666ZM13.3337 10.625H10.6253V13.3333C10.6253 13.675 10.342 13.9583 10.0003 13.9583C9.65866 13.9583 9.37533 13.675 9.37533 13.3333V10.625H6.66699C6.32533 10.625 6.04199 10.3417 6.04199 10C6.04199 9.65833 6.32533 9.375 6.66699 9.375H9.37533V6.66666C9.37533 6.325 9.65866 6.04166 10.0003 6.04166C10.342 6.04166 10.6253 6.325 10.6253 6.66666V9.375H13.3337C13.6753 9.375 13.9587 9.65833 13.9587 10C13.9587 10.3417 13.6753 10.625 13.3337 10.625Z"
                                            fill="#292D32" />
                                    </svg>
                            ...
                            <table id="inflanar-table__order" class="inflanar-table__main inflanar-table__main-v2">
                                ...
                                <thead class="inflanar-table__head">
                                    <tr>
                                        ...
                                        <th class="inflanar-table__column-2 inflanar-table__h2">
                                            {{ __('admin.Ticket Info') }}</th>
                                        <th class="inflanar-table__column-3 inflanar-table__h3">
                                            {{ __('admin.Unread Message') }}</th>
                                        <th class="inflanar-table__column-4 inflanar-table__h4">{{ __('admin.Status') }}
                                        </th>
                                        <th class="inflanar-table__column-5 inflanar-table__h5">{{ __('admin.Action') }}
                                        </th>
                                    </tr>
                                </thead>
                                    ...
                                    @foreach ($tickets as $index => $ticket)
                                        <tr>
                                            ...
                                            <td class="inflanar-table__column-2 inflanar-table__data-2">
                                                <div class="inflanar-table__content">
                                                    <p class="inflanar-table__desc">{{ __('admin.Subject') }}:
                                                        {{ html_decode($ticket->subject) }}</p>
                                                    <p class="inflanar-table__desc">{{ __('admin.Ticket Id') }}:
                                                        {{ $ticket->ticket_id }}</p>
                                                    <p class="inflanar-table__desc"> {{ __('admin.Created') }}:
                                            ...
                                            <td class="inflanar-table__column-6 inflanar-table__data-6">
                                                <div class="inflanar-table__status__group">
                                                    <a href="{{ route('user.support-ticket', $ticket->ticket_id) }}"
                                                        class="inflanar-table__action inflanar-table__action--view">

...
@section('frontend-content')
                            ...
                            <div class="inflanar-supports__password--form">
                                <form action="{{ route('user.update-password') }}" method="POST">
                                    ...
                                    <div class="inflanar__item-button--group mg-top-50">
                                        <button class="inflanar-btn"
                                            type="submit">{{ __('admin.Update Password') }}</button>
                                        <a href=""
                                            class="inflanar-btn inflanar-btn__cancel"><span>{{ __('admin.Cancel') }}</span></a>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <style>
        <style>.cus-edit-profile .inflanar-supports input {
            border-radius: 8px;

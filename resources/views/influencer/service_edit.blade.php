    ...
    <section class="section">
      ...
      <div class=" head-title">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <h5 class="mb-3 service_card 2">{{__('admin.Language Translation')}}</h5>
              <hr>
                        ...
                        <div class="card-body">
                            ...
                            <div class="lang_list_top">
                                <ul class="lang_list">
                                    @foreach ($language_list as $language)
                                        <li><a
                                                href="{{ route('influencer.service.edit', ['service' => $service->id, 'lang_code' => $language->lang_code]) }}"><i
                                                    class="fas fa-edit"></i> {{ $language->lang_name }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
            ...
            <form action="{{ route('influencer.service.update', $service->id) }}" method="POST"
                                                ...
                                                <select name="category_id" id="" class="form-control select2">
                                                    ...
                                                    @foreach ($categories as $category)
                                                        <option
                                                            ...
                                                            value="{{ $category->id }}">{{ $category->translate->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                                ...
                                                @if ($feature)
                                                    <div class="col-12 pacakge_feature_row">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                <button type="button"
                                                                    class="btn btn-danger btn_mt_33 delete_package_feature"><i
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        @if (front_lang() == request()->get('lang_code'))
                                            <div class="form-group col-12">
                                                ...
                                                <input type="text" class="form-control tags" name="tags"
                                                    autocomplete="off" value="{{ $service->tags }}">
                                            </div>
                                        @endif
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <input type="text" class="form-control" name="seo_title"
                                                autocomplete="off" value="{{ $translate->seo_title }}">
                                        </div>
                                        ...
                                        @if (front_lang() == request()->get('lang_code'))
                                            <div class="form-group col-12">
                                                ...
                                                <select name="status" id="" class="form-control">
                                                    <option {{ $service->status == 'active' ? 'selected' : '' }}
                                                        value="active">{{ __('admin.Active') }}</option>
                                                    <option {{ $service->status == 'inactive' ? 'selected' : '' }}
                                                        value="inactive">{{ __('admin.Inactive') }}</option>
                                                </select>
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <button class="btn btn-primary"
                                        type="submit">{{ __('admin.Update Service') }}</button>
                                </div>

                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" name="booking_id" class="form-control"
                                    ...
                                    <div class="img-title">
                                        <div class="edit-btns">
                                            ...
                                            @elseif ($order->order_status == 'order_decliened_by_influencer')
                                                <span
                                                    class="badge badge-danger">{{ __('admin.Declined by influencer') }}</span>
                                            ...
                                            @if ($order->order_status == 'awaiting_for_influencer_approval')
                                                <a href="javascript:;" data-toggle="modal"
                                                    data-target="#approvedOrder-{{ $order->id }}"
                                                    class="btn btn-primary btn-sm"><i class="fas fa-check"></i>
                                                    <!-- {{ __('admin.Approved') }} -->
                                                </a>

                                                <a href="javascript:;" data-toggle="modal"
                                                    data-target="#declinedOrder-{{ $order->id }}"
                                                    class="btn btn-danger btn-sm"><i class="fas fa-times"></i>
                                                    <!-- {{ __('admin.Declined') }} -->
                                                </a>
                                            @endif
                                            <a href="{{ route('influencer.booking-show', $order->order_id) }}"

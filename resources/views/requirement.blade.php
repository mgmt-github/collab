...
@section('frontend-content')
                ...
                <div class="order-form">
                    ...
                    <form class="form-group">
                        <label for="note" class="note-label">
                            <span>{{ __('admin.Write Note') }} </span><span class="note-count">0/5000</span>
                        </label>
                        <div class="note-row">
                            <input id="note" rows="3" placeholder="I want 2 Video ..." />
                            <span class="attachment">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" id="attachment-icon">
                                    <path
    ...
    <script>
        // Trigger file input when the attachment icon is clicked
        document.getElementById("attachment-icon").addEventListener("click", function() {
        ...
        // Update character count in the text area
        const note = document.getElementById("note");
        const noteCount = document.querySelector(".note-count");
        note.addEventListener("input", function() {
            const currentLength = note.value.length;
            noteCount.textContent = `${currentLength}/5000`;
        });
    </script>
    <style>
        .footer-cta,
